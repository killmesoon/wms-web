    ...
    <div id="bottomView" ref="bottomView" class="bottom-view">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane name="second">
          ...
          <inbound-detail-table ref="inboundDetailTable"></inbound-detail-table>
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
...
import InboundDetailTable from './component/InboundDetailTable'
  ...
  mounted() {
    ...
    oDiv.onmousedown = function(ev) {
      ...
      document.onmousemove = function(ev) {
        ...
        that.$refs.accountTable.initTaleHeight()
        that.$refs.accountTable2.initTaleHeight()
      }
    }
    ...
    initViewHeight() {
      this.$nextTick(() => {
        ...
        if (mainView) {
          ...
          this.$refs.accountTable.initTaleHeight()
