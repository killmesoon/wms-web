<template>
    <div class="inbound-header-form">
        <el-button type="primary" size="mini"
                   icon="el-icon-plus" @click="lineAdd">录入
        </el-button>
        ...
        <el-dialog :append-to-body="applyToBody" :visible.sync="dialogLineOrderVisible" width="55%"
            ...
            <el-form :model="formLine" size="small" label-position="right" ref="outboundLineForm" :inline="isFormInline">
                ...
                <el-form-item label="来源单据类型"  :label-width="formLabelWidth">
                    <el-select v-model="formLine.sourceDocTypeItem" placeholder="请选择来源单据类型" value-key="dicId" @change="sourceDocTypeChange">
