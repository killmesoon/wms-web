    ...
    <div ref="mainContent" class="main-content">
        ...
        <div>
            ...
            >
                ...
                <el-table-column prop="uomTypeDic" label="单位类型">
                </el-table-column>
                <el-table-column prop="primaryFlag" align="center" label="是否主单位">
    ...
    methods: {
      ...
      confirmSubmit() {
        ...
        if (this.searchFlag) {
          ...
          this.$refs.uomDialog.$refs.uomForm.validate((valid) => {
            if (valid) {
      ...
      resetAll() {
        if (!this.searchFlag) {
          this.$refs.uomDialog.$refs.uomForm.resetFields()
        }
        this.form = {}
        this.$refs.uomDialog.primaryFlagDisable = true
      }
    }
  }
</script>
