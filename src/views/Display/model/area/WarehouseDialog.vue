<template>
    <div>
        <el-form :model="form" size="small" ref="warehouseForm" label-position="left" :inline="isFormInline">
            ...
            <el-form-item label="允许负库存" :label-width="formLabelWidth" prop="negativeFlag"
            ...
            <el-form-item label="是否盘点" :label-width="formLabelWidth" prop="panrangeFlag"
            ...
            <el-form-item label="是否有效" :label-width="formLabelWidth" prop="enableFlag"
            ...
            <el-form-item label="仓库简称" :label-width="formLabelWidth" prop="shortName"
