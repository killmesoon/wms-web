<template>
    <div>
        <el-form :model="form" size="small" label-position="right" ref="areaForm" :inline="isFormInline">
            ...
            >
                <el-select v-model="form.wareHouse" placeholder="请选择仓库编码" @change="warehouseChange" value-key="warehouseCode">
            ...
            <el-form-item v-else label="仓库编码" :label-width="formLabelWidth" prop="warehouseCode"
                ...
                <el-select v-model="form.warehouseCode" placeholder="请选择仓库编码" @change="warehouseChange" value-key="warehouseCode">
                    <el-option v-for="wareHouse in warehouseList" :key="wareHouse.warehouseId"
                               :label="wareHouse.warehouseCode"
                               :value="wareHouse">
                    </el-option>
            ...
            <el-form-item v-if="flag" prop="areaName"   label="区域名称" :label-width="formLabelWidth">
