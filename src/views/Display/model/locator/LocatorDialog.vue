<template>
    <div>
        <el-form :model="form" size="small" label-position="right" ref="locatorForm" :inline="isFormInline">
            ...
            <el-form-item v-if="flag" label="仓库编码" :label-width="formLabelWidth" prop="wareHouse.warehouseCode"
                          >
                <el-select v-model="form.wareHouse" @change="warehouseChange"  placeholder="请选择工厂编码" value-key="warehouseId">
            ...
            <el-form-item v-else label="仓库编码" :label-width="formLabelWidth" prop="warehouseCode"
                ...
                <el-select v-model="form.warehouseCode" @change="warehouseChange" placeholder="请选择工厂编码" value-key="warehouseId">
                    <el-option v-for="wareHouse in warehouseList" :key="wareHouse.warehouseId"
                               :label="wareHouse.warehouseCode"
                               :value="wareHouse">
                    </el-option>
