<template>
    <div>
        <el-form :model="form" size="small" label-position="left" ref="locatorForm" :inline="isFormInline">
            <el-form-item label="工厂编码" :label-width="formLabelWidth" prop="plantCode"
            ...
            <el-form-item label="仓库编码" :label-width="formLabelWidth" prop="wareHouse.warehouseCode"
            ...
            <el-form-item label="区域编码" :label-width="formLabelWidth" prop="area.areaCode"
            ...
            <el-form-item label="货位编码" :label-width="formLabelWidth" prop="locatorCode" :rules="[{ required: true, message: '请输入货位编码', trigger: 'blur' }]">
                <el-input v-model="form.locatorCode" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="货位名称" :label-width="formLabelWidth" prop="locatorName" :rules="[{ required: true, message: '请输入货位名称', trigger: 'blur' }]">
                <el-input v-model="form.locatorName" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="货位类型" :label-width="formLabelWidth" prop="locatorType" :rules="[{ required: true, message: '请选择货位类型', trigger: 'change' }]">
            ...
            <el-form-item label="是否有效" :label-width="formLabelWidth" prop="enableFlag" :rules="[{ required: true, message: '请选择是否有效', trigger: 'change' }]">
